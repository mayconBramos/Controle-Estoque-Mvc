...
namespace Gestao_Estoque_Mvc.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Telefone,Endereco")] Clientes clientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Telefone,Endereco")] Clientes clientes)
        {
            if (id != clientes.Id)
            {
                return NotFound();
